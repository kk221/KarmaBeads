...
export default function Header() {
  ...
  return (
    <>
      <header className="fixed w-full top-0 z-50 bg-[#1d2a3a]">
            ...
            <div className="flex items-center gap-4">
              <Link href="/" className="flex items-center gap-3">
                <Image
                  ...
                  className="w-10 h-10"
                />
                <span className="text-2xl font-playfair text-[#d3ae8b]">
                  KarmaBeads
                </span>
              </Link>
            </div>
            ...
            <div className="hidden lg:flex items-center gap-12">
              {navLinks.map((link) => (
                <Link
                  key={link.href}
                  href={link.href}
                  className={`text-lg font-playfair transition-colors hover:text-[#d3ae8b] ${
                    pathname === link.href 
                      ? 'text-[#d3ae8b]' 
                      : 'text-[#d3ae8b]/80'
                  }`}
